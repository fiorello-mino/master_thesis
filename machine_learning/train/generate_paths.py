...
import numpy as np
base_dir = Path("/data/fiorello/dataset_128")
output_txt = "test_set_128.txt"

n_folders = 200          # 0000 ... 0999
...
with open(output_txt, "w") as f:
    for folder_idx in range(160, n_folders):
        folder = base_dir / f"{folder_idx:04d}"
        start_index = np.random.randint(1,151)
