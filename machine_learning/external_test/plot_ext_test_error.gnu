...
set output 'max_MAE_test_64_frame_1_vs_2.png'

set title 'Comparing max MAE external test for models trained with different framerates (log scale)'
set xlabel 'Test set'
set ylabel 'MAE'
set grid
...
plot \
     'dataset_64_2_ext_test/lr_5e-5_hl_3_2_tr_10/errors.txt' using ($0):2 with lines lw 1.5 lc rgb "#0072B2" title 'double framerate', \
     'dataset_64_ext_test/lr_5e-5_hl_3_tr_5/errors_half_t.txt' using ($0):2 with lines lw 1.5 lc rgb "#E41A1C" title 'normal framerate'
