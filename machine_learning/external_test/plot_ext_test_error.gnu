...
set title 'Overall MSE validation set vs external test set (log scale)'
set xlabel 'Test set'
set ylabel 'MSE'
set grid
...
plot \
     ...
     'ext_test_lr_5e-5_hl_3/dataset_64_random/errors.txt' using ($0):5 with lines lw 1.5 lc rgb "#984EA3" title 'external test'
