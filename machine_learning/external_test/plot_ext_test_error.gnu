...
set output 'MSE_test_64_frame_1_vs_2.png'

set title 'Comparing overall MSE external test for models trained with different framerates (log scale)'
set xlabel 'Test set'
set ylabel 'MSE'
set grid
...
plot \
     'dataset_64_2_ext_test/lr_5e-5_hl_3_2_tr_10/errors.txt' using ($0):5 with lines lw 1.5 lc rgb "#0072B2" title 'double framerate', \
     'dataset_64_ext_test/lr_5e-5_hl_3_tr_5/errors.txt' using ($0):5 with lines lw 1.5 lc rgb "#E41A1C" title 'normal framerate'
