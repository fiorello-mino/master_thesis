...
set title 'Max MSE for different models, dataset 64x64 random (log scale)'
set xlabel 'Test set'
set ylabel 'MSE'
set grid
...
plot \
     ...
     'ext_test_lr_5e-5_hl_3/dataset_64_random/errors.txt' using ($0):2 with lines lw 1.5 lc rgb "#984EA3" title 'lr = 5e-5 hl = 3'
