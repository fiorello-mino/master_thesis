...
# <<< SCRIPT VARIABLES <<<
MODEL_PATH      : str   = '/home/fiorello/master_thesis/machine_learning/train_logs/test/model/epoch_497.pt' # model
SEQUENCE_TABLE  : str   = 'test_set_conforme.txt'
IMG_SIZE        : int   = 64 # resizing dimension of images in dataset
OUTPUT_FOLDER   : str   = '/home/fiorello/master_thesis/machine_learning/initial_test/test/'#' # output folder name
